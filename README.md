...
各 lab 的说明与产出物要求：[lab1](docs/requirement/lab1.md) · [lab2](docs/requirement/lab2.md) · [lab3](docs/requirement/lab3.md) · [lab4](docs/requirement/lab4.md)。文档为课程原始要求的完整副本，其中的打包提交说明仅在教学场景下适用，自学或验证时跳过即可。
